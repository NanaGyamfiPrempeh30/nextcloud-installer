...
| Platform | Status |
|---|---|
| Ubuntu 24.04 LTS | Tested and verified — full install, idempotent re-run, DB-unreachable failure path (EXIT_DATABASE=40), full reset-reinstall cycle, stale config.php recovery (REQ-24), and optional app install/enable (REQ-13) all proven |
